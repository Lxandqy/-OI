...
<img src="C:%5CUsers%5CAdmin%5CAppData%5CRoaming%5CTypora%5Ctypora-user-images%5Cimage-20230224183727810.png" alt="image-20230224183727810" style="zoom:80%;" />
...
![image-20230224183809983](C:%5CUsers%5CAdmin%5CAppData%5CRoaming%5CTypora%5Ctypora-user-images%5Cimage-20230224183809983.png)
...
![image-20230224183936554](C:%5CUsers%5CAdmin%5CAppData%5CRoaming%5CTypora%5Ctypora-user-images%5Cimage-20230224183936554.png)
...
讨论$log_2T$，若$T$是2的次幂倍，那么得到的答案就是最高位，满足条件。

如果$T$不是2的次幂倍，那么得到的答案一定是 > 最高位，此时我们只需要向下取整得到的答案是 >= 最高位，也满足条件。
...
for(int i = 1; i <= m; i++){
        scanf("%d %d",&l,&r);
        sum1 = max(f[l][log2(r - l + 1)],f[r - 1<<(log2(r - l + 1) + 1)][log2(r - l + 1)]);
        sum2 = min(f2[l][log2(r - l + 1)],f2[r - 1<<(log2(r - l + 1) + 1)][log2(r - l + 1)])
        printf("%d\n",sum1 - sum2);
    }
```
